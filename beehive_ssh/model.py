...
class SshUser(Base, BaseSshEntity):
    ...
    def __init__(self, objid, name, username, password, attribute=None, desc='', active=True, expiry_date=None):
        BaseSshEntity.__init__(self, objid, name, desc, active, attribute)
...
class SshNode(Base, BaseSshEntity):
    ...
    def __init__(self, objid, name='', active=True, desc='', attribute=None, node_type='', ip_address='', group=None):
        BaseSshEntity.__init__(self, objid, name, desc, active, attribute)
